...
$crear_bd = "CREATE DATABASE IF NOT EXISTS killabar_botanero_ventas";
...
$conexion->exec('USE killabar_botanero_ventas');
#Ahora crear las tablas
//$conexion->close();

$conexion = new PDO("mysql:host=$host;dbname=killabar_botanero_ventas", $usuario, $password);
$conexion->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
