              ...
              <div class="columns is-centered">
                  <div class="column is-5-tablet is-6-desktop is-6-widescreen">
                      <form action="" class="box">
                          <img src="@/assets/logoPrinCafe.png" alt="" height="150" width="150" style="display: block; margin:0 auto;">
  ...
  methods: {
      ingresar() {
          ...
          HttpService.obtenerConDatos(payload, "iniciar_sesion.php")
              .then(log => {
                  console.log('Datos de inicio de sesión:', log); // Verificar la respuesta
                  ...
                  if (log.resultado) {
                      ...
                      // Almacenar el role_id en el almacenamiento local
                      localStorage.setItem('role_id', log.datos.role_id)
                      localStorage.setItem('nombreUsuario', log.datos.nombreUsuario)

                      console.log('Role ID:', log.datos.role_id); // Verificar el role_id
