<template>
  <b-navbar class="fondo is-primary">
    <template #brand>
      <b-navbar-item>
        <img src="@/assets/logoCafeteria.png" alt="logo" width="50" height="50">
    ...
    <template #start>
      ...
      <b-navbar-item v-if="role_id == 3" tag="router-link" :to="{ path: '/insumos' }">
      ...
      <b-navbar-item v-if="role_id == 3" tag="router-link" :to="{ path: '/categorias' }">
        <b-icon icon="archive-outline"></b-icon>
        <span></span>
        Categorías
      </b-navbar-item>

      <b-navbar-item v-if="role_id == 3" tag="router-link" :to="{ path: '/usuarios' }">
        <b-icon icon="account-group"></b-icon>
        <span></span>
        Usuarios
      </b-navbar-item>

      <b-navbar-item v-if="role_id == 3" tag="router-link" :to="{ path: '/reporte-ventas' }">
        <b-icon icon="cash-register"></b-icon>
        <span></span>
        Ventas
      </b-navbar-item>

      <b-navbar-item v-if="role_id == 3" tag="router-link" :to="{ path: '/configurar' }">
